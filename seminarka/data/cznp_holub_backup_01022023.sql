...
--
-- Name: color_to_css_class(character varying); Type: FUNCTION; Schema: public; Owner: doctordehi
--

CREATE FUNCTION public.color_to_css_class(nazev character varying) RETURNS character varying
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION public.color_to_css_class(nazev character varying) OWNER TO doctordehi;

--
-- Name: colortocssclass(character varying); Type: FUNCTION; Schema: public; Owner: doctordehi
--

CREATE FUNCTION public.colortocssclass(nazev character varying) RETURNS character varying
    LANGUAGE sql STABLE
    AS $$
SELECT 'color--' || replace(unaccent(nazev), ' ', '-');
$$;
...
ALTER FUNCTION public.colortocssclass(nazev character varying) OWNER TO doctordehi;

--
-- Name: log_plemeno_inserted(); Type: FUNCTION; Schema: public; Owner: doctordehi
--

CREATE FUNCTION public.log_plemeno_inserted() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
	BEGIN 
...
ALTER FUNCTION public.log_plemeno_inserted() OWNER TO doctordehi;

--
-- Name: pocet_plemen_v_barve(character); Type: FUNCTION; Schema: public; Owner: doctordehi
--

CREATE FUNCTION public.pocet_plemen_v_barve(barva character) RETURNS character
    LANGUAGE sql STABLE
    AS $$
...
ALTER FUNCTION public.pocet_plemen_v_barve(barva character) OWNER TO doctordehi;

--
-- Name: cspell; Type: TEXT SEARCH DICTIONARY; Schema: public; Owner: postgres
--

CREATE TEXT SEARCH DICTIONARY public.cspell (
    TEMPLATE = pg_catalog.ispell,
    dictfile = 'czech', afffile = 'czech', stopwords = 'czech' );


ALTER TEXT SEARCH DICTIONARY public.cspell OWNER TO postgres;

--
-- Name: cs; Type: TEXT SEARCH CONFIGURATION; Schema: public; Owner: postgres
--

CREATE TEXT SEARCH CONFIGURATION public.cs (
    PARSER = pg_catalog."default" );

ALTER TEXT SEARCH CONFIGURATION public.cs
    ADD MAPPING FOR asciiword WITH public.cspell, simple;

ALTER TEXT SEARCH CONFIGURATION public.cs
    ADD MAPPING FOR word WITH public.cspell, simple;
...
ALTER TEXT SEARCH CONFIGURATION public.cs OWNER TO postgres;
...
--
-- Name: mista_puvodu; Type: TABLE; Schema: public; Owner: doctordehi
--

CREATE TABLE public.mista_puvodu (
    id_mis integer NOT NULL,
    nazev character varying(50) NOT NULL,
    zeme integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.mista_puvodu OWNER TO doctordehi;

--
-- Name: mista_puvodu_id_mis_seq; Type: SEQUENCE; Schema: public; Owner: doctordehi
--
...
ALTER TABLE public.mista_puvodu_id_mis_seq OWNER TO doctordehi;

--
-- Name: mista_puvodu_id_mis_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doctordehi
--
...
CREATE TABLE public.plemena (
    ...
    strucny_popis text,
    narodni_plemeno boolean DEFAULT false NOT NULL
);
...
--
-- Name: plemena_inserted_log; Type: TABLE; Schema: public; Owner: doctordehi
--

CREATE TABLE public.plemena_inserted_log (
    id_ins integer NOT NULL,
    plemeno integer NOT NULL,
    datum timestamp without time zone NOT NULL,
    uzivatel character varying NOT NULL
);


ALTER TABLE public.plemena_inserted_log OWNER TO doctordehi;

--
-- Name: plemena_inserted_log_id_ins_seq; Type: SEQUENCE; Schema: public; Owner: doctordehi
--

CREATE SEQUENCE public.plemena_inserted_log_id_ins_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.plemena_inserted_log_id_ins_seq OWNER TO doctordehi;

--
-- Name: plemena_inserted_log_id_ins_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doctordehi
--

ALTER SEQUENCE public.plemena_inserted_log_id_ins_seq OWNED BY public.plemena_inserted_log.id_ins;
...
--
-- Name: zeme_puvodu; Type: TABLE; Schema: public; Owner: doctordehi
--

CREATE TABLE public.zeme_puvodu (
    id_zem integer NOT NULL,
    nazev character varying(50) NOT NULL,
    zkratka character varying(50) NOT NULL
);


ALTER TABLE public.zeme_puvodu OWNER TO doctordehi;

--
-- Name: plemena_shrnuti; Type: VIEW; Schema: public; Owner: doctordehi
--

CREATE VIEW public.plemena_shrnuti AS
 SELECT p.nazev AS plemeno,
    s.nazev AS skupina,
   ...
   FROM (((((((public.skupiny s
     RIGHT JOIN public.plemena p ON ((p.skupina = s.id_sku)))
     LEFT JOIN public.mista_puvodu mp ON ((mp.id_mis = p.misto_puvodu)))
     LEFT JOIN public.zeme_puvodu zp ON ((zp.id_zem = mp.zeme)))
     LEFT JOIN public.plemena_razy pr ON ((pr.ple = p.id_ple)))
     JOIN public.barevne_razy br ON ((br.id_raz = pr.raz)))
     JOIN public.barvy b ON ((b.id_bar = br.bar)))
     JOIN public.kresby k ON ((k.id_kre = br.kre)))
  GROUP BY s.nazev, p.nazev, mp.nazev, zp.zkratka;


ALTER TABLE public.plemena_shrnuti OWNER TO doctordehi;
...
--
-- Name: zeme_puvodu_id_zem_seq; Type: SEQUENCE; Schema: public; Owner: doctordehi
--

CREATE SEQUENCE public.zeme_puvodu_id_zem_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.zeme_puvodu_id_zem_seq OWNER TO doctordehi;

--
-- Name: zeme_puvodu_id_zem_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: doctordehi
--

ALTER SEQUENCE public.zeme_puvodu_id_zem_seq OWNED BY public.zeme_puvodu.id_zem;
...
--
-- Name: mista_puvodu id_mis; Type: DEFAULT; Schema: public; Owner: doctordehi
--
...
--
-- Name: plemena_inserted_log id_ins; Type: DEFAULT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.plemena_inserted_log ALTER COLUMN id_ins SET DEFAULT nextval('public.plemena_inserted_log_id_ins_seq'::regclass);
...
--
-- Name: zeme_puvodu id_zem; Type: DEFAULT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.zeme_puvodu ALTER COLUMN id_zem SET DEFAULT nextval('public.zeme_puvodu_id_zem_seq'::regclass);
...
--
-- Data for Name: mista_puvodu; Type: TABLE DATA; Schema: public; Owner: doctordehi
--

COPY public.mista_puvodu (id_mis, nazev, zeme) FROM stdin;
1	Benešov a okolí	1
2	Morava	1
3	Jižní Čechy	1
4	Slezsko	1
...
8	Čechy a Morava	1
9	Čechy	1
10	Česká Republika	1
11	Haná, Morava	1
12	Praha a okolí	1
13	Rakovník a okolí	1
14	Horní Rakousko	2
\.
...
COPY public.plemena (id_ple, nazev, sk_nazev, de_nazev, uk_nazev, skupina, velikost, misto_puvodu, krouzek, strucny_popis, narodni_plemeno) FROM stdin;
1	Benešovský holub	Benešovský holub	Beneschauer Taube	Benesov Pigeon	1	2	1	10	Holub polního typu, silné tělesné stavby. Tělo je neseno v mírném sklonu nazad. Vyniká užitkovostí, dobrámi letovými schopnostmi, včetně polaření. Původně s vyskytoval jen v rázu modrém bezpruhém. Cílem je rozšíření počtu barevných a kresebných rázů při zachování původního typu a užitkových vlastností.	t
2	Brněnský voláč	Brnenský hrvoliak	Brünner Kröpfer	Bruenner Cropper	4	1	8	7	Zakrslý, vysokonohý voláč, vynikajících jemných tělesných tvarů s velmi vzpřímenou a štíhlou postavou. Ušlechtilý dojem dotváří kulaté podvázené vole a znatelná hrudní kost. Typickým plemenným znakem jsou vysoko nesená a křížící se křídla. K původním znakům patří i jeho typické životní projevy: temperament, žabí skoky samců, našlapování na přední část prstů a úklony při vrkání, tleskání křídly a zvláštní způsob vrkání, jako by ze sevřeného hrdla. Oblíben je i pro krotkost, důvěřivost a přítulnost k chovateli. Patří k plemenům s vysokou výstavní hodnotou.	t
3	Česká bagdeta	Česká bagdeta	Tschechische Bagdette	Czech Bagdad	2	2	5	9	Poměrně silný holub, střední velikosti, s dobrými letovými schopnostmi, původně polařící, s cennými znaky hlavy, zobáku a obočnic, které jej přiřazují mezi plemena bradavičnatá. Vyniká i řadou barevných a kresebných rázů.	t
4	Česká čejka	Český cíbik	Böhmische Flügeltaube	Bohemian Wing Pigeon	5	2	3	11	Typ středně silného polního holuba, kratšího tvaru, s nízkým a širokým postojem v mírném sklonu nazad, dobře vyvinutých pernatých ozdob (hladkonozí, rousní, hladkohlaví, chocholatí), přesné kresby a syté barvy.	t
5	Česká lyska běloocasá	Česká lyska bielochvostá	Böhmische Schnippe weisschwanzig	Czech spot Whitetail	5	2	9	11	Velikostí a celkovým dojmem připomíná středné silného polního holuba s bílou čelní lysinkou a bílým ocasem a charakteristickými barevnými a kresebnými kombinacemi.	t
6	Český bublák	Český bublák	Tschechische Trommeltaube	Czech Trumpeter	6	2	10	12	Holub patřící do skupiny bubláků, vyznačuje se zvláštním hlasovým projevem – bubláním, které je nejcennějším plemenným znakem. Bublání nesmí být monotónní, musí se střídat vyšší tóny s hlubšími, musí být výrazné a dobře slyšitelné a čím déle trvá, tím je holub cennější. Holubice bublají v kratších intervalech a ve vyšším tónu. Typickým dokonalým znakem je dokonalost postavy, je kompaktní, nízká, široká a krátka, v průhledu ze předu musí být prostor mezi břichem, nohama a rousem zcela zaplněn. Dalším znakem je jakoby slité a přilehlé opeření a husté, velmi vyvinuté rousy, supí pera a vrkoče.	t
7	Český holub	Český holub	Böhmentaube	Bohemian Pigeon	5	2	9	8	Silnější polní holub s vodorovným tělem, středně vysokého postoje, hladkonohý a hladkohlavý, dobře létající.	t
8	Český rejdič	Český letún	Tschechischer Tümmler	Czech Tumbler	9	1	12	8	Je cenným plemenem rejdiče pro dobré letové schopnosti v hejnu po dobu 1-2 hodin a pro hodnotný okrasný exteriér. Charakterizuje jej jemná střední postava, lasturovitá chocholka a opeřené nohy s krátkými rousky.	t
...
10	Český voláč sivý	Český sivý hrvoliak	Tschechischer Eiskröpfer	Czech Ice Cropper	4	2	10	8	Voláč střední velikosti se silnější, mírně vztyčenou postavou a dobrou volatostí. Vyniká typickým sivým zbarvením s černými pruhy nebo kaprováním štítů křídel.	t
11	Hanácký voláč	Hanácký hrvoliak	Hana Kröpfer	Hana Pouter	4	3	11	11	Statný, dobře volatý, vysokonohý a rousný voláč s pštrosí kresbou. Požadavky na dokonalost tělesných tvarů jsou vysoké. Barva, lesk a svit nejsou podstatné.	t
12	Moravská bagdeta	Moravská bagdeta	Mährische Bagdette	Morovia Bagdad	2	2	6	10	Holub silné tělesné stavby a většího rámce. Vyniká užitkovostí, postavou, tvarem hlavy, špičatou chocholkou a výraznými obočnicemi.	t
13	Moravský bělohlávek	Moravský bielohlávok	Mährischer Weißkopfkröpfer	Bohemian Cropper	4	2	2	9	Holub ze skupiny středních voláčů, vyšší a vzpřímené postavy, se silnější stavbou těla a dobrou volatostí. Hlava je zdobena špičatou chocholkou.	t
14	Moravský morák	Moravský morák	Mährischer Morak	Moravian Morak Cropper	4	2	2	9	Voláč ze skupiny středních voláčů. Velikostí se řadí mezi největší plemena ve skupině. Vyniká silnou postavou většího tělesného rámce a velmi dobrým voletem hruškovitého tvaru, vitalitou a plodností. Je zvláštní tím, že se vyskytuje jen v jedinem barevném a kresebném rázu.	t
15	Moravský pštros	Moravský pštros	Mährischer Strasser	Moravian Strasser	1	2	2	9	Původně užitkové plemeno střední velikosti polního typu s typickou pštrosí kresbou. Vysoce prošlechtěných barev a lesků. V současnosti má též znaky holuba vynikajícich tvarů s přiměřenou hmotností.	t
16	Moravský voláč sedlatý	Moravský hrvoliak sedlatý 	Mährischer Elsterkröpfer	Moravian Magpie Cropper	4	2	2	9	Holub ze skupiny středních voláčů, vysoké a vzpřímené postavy, vyskytující se jen v sedlatém rázu. Hlava je zdobena špičatou chocholkou. Vyniká vitalitou a plodností.	t
17	Ostravská bagdeta	Ostravská bagdeta	Ostrauer Bagdette	Ostrava Bagdad	2	2	7	9	Holub silné tělesné stavby, vzpřímený, na vyšších nohách. Typickým znakem plemena je křivka krku ve tvaru písmene S, kterou tvoří profil hlavy se zobákem, dozadu prohnutý týl a vpředu vystupující krční obratle a nasazení krku ke hrudi. Dále je charakteristický dobře znatelný lalůček na spodní straně krku, a na horní části hrudi na obě strany kolmo rozčísnutá náprsenka.	t
18	Prácheňský káník	Prachenský kaník	Prachener Kanik	Prachen Kanik	1	2	3	8	Temperamentní, velmi plodný holub s výbornými letovými schopnostmi, včetně polaření. Původně užitkové plemeno lehčího polního typu, v současnosti plemeno s vysokou výstavní a chovatelskou hodnotou. Má kompaktní jemnou tělesnou stavbu, vyniká pěknou bělohrotou gazzi kresbou a jemnými a čistými barvami.	t
...
21	Rakovnický kotrlák	Rakovnícky kotrmeliak	Rakovnik Roller	Rakovnik Roller	9	1	13	7	Drobný a jemný holub, který vyniká temperamentem a přeevším zvláštním způsobem letu – válením, které probíhá za letu tak, že se holub v přemetech otáčí nazad. Čím více přemetů udělá, tím je chovná hodnota větší. Nejcennější holubi válejí i nízko nad zemí nebo nad hřebenem střechy. Vynika rozmanitými barevnými a kresebnými rázy.	t
22	Slezský barevnohlávek	Sliezsky farebnohlávok	Schlesischer Farbenkopf	Silesian Colourhead	1	2	4	9	Holub středního užitkového typu, vynikajících letových vlastností včetně polaření. Jeho užitkovost vyplývá z nenáročnosti a značné otužilosti. Mimoto je i ceněným plemenem okrasným a výstavním.	t
23	Slezský voláč	Sliezsky hrvoliak	Schlesischer Kröpfer	Silesian Cropper	4	2	4	8	Štíhlý, harmonický, elegantní, ale přesto silný voláč s velmi dobrou volatostí hruškovitého tvaru, zadní partie kratší (2/5) vztyčeného postoje, mírně duté linie zad, živého temperamentu.	t
24	Vídeňský slepičák	\N	Huhnschecke	Hungarian	3	3	14	10	Silným, hrdým dojmem působící slepičák. Nápadná kresba je vlastní tomuto plemeni.	f
\.


--
-- Data for Name: plemena_inserted_log; Type: TABLE DATA; Schema: public; Owner: doctordehi
--

COPY public.plemena_inserted_log (id_ins, plemeno, datum, uzivatel) FROM stdin;
2	24	2023-01-31 01:08:05.746103	doctordehi
\.
...
--
-- Data for Name: zeme_puvodu; Type: TABLE DATA; Schema: public; Owner: doctordehi
--

COPY public.zeme_puvodu (id_zem, nazev, zkratka) FROM stdin;
...
--
-- Name: mista_puvodu_id_mis_seq; Type: SEQUENCE SET; Schema: public; Owner: doctordehi
--

SELECT pg_catalog.setval('public.mista_puvodu_id_mis_seq', 2, true);
...
SELECT pg_catalog.setval('public.plemena_id_ple_seq', 1, true);


--
-- Name: plemena_inserted_log_id_ins_seq; Type: SEQUENCE SET; Schema: public; Owner: doctordehi
--

SELECT pg_catalog.setval('public.plemena_inserted_log_id_ins_seq', 2, true);
...
--
-- Name: zeme_puvodu_id_zem_seq; Type: SEQUENCE SET; Schema: public; Owner: doctordehi
--

SELECT pg_catalog.setval('public.zeme_puvodu_id_zem_seq', 2, true);
...
--
-- Name: mista_puvodu mista_puvodu_pkey; Type: CONSTRAINT; Schema: public; Owner: doctordehi
--
...
--
-- Name: plemena_inserted_log plemena_inserted_log_pkey; Type: CONSTRAINT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.plemena_inserted_log
    ADD CONSTRAINT plemena_inserted_log_pkey PRIMARY KEY (id_ins);
...
--
-- Name: zeme_puvodu zeme_puvodu_pkey; Type: CONSTRAINT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.zeme_puvodu
    ADD CONSTRAINT zeme_puvodu_pkey PRIMARY KEY (id_zem);


--
-- Name: idx_strucny_popis_plemene; Type: INDEX; Schema: public; Owner: doctordehi
--

CREATE INDEX idx_strucny_popis_plemene ON public.plemena USING gin (to_tsvector('simple'::regconfig, strucny_popis));


--
-- Name: idx_strucny_popis_plemene_cs; Type: INDEX; Schema: public; Owner: doctordehi
--

CREATE INDEX idx_strucny_popis_plemene_cs ON public.plemena USING gin (to_tsvector('public.cs'::regconfig, strucny_popis));


--
-- Name: plemena plemeno_inserted; Type: TRIGGER; Schema: public; Owner: doctordehi
--

CREATE TRIGGER plemeno_inserted AFTER INSERT ON public.plemena FOR EACH ROW EXECUTE FUNCTION public.log_plemeno_inserted();
...
--
-- Name: plemena_inserted_log plemeno_fk; Type: FK CONSTRAINT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.plemena_inserted_log
    ADD CONSTRAINT plemeno_fk FOREIGN KEY (plemeno) REFERENCES public.plemena(id_ple) ON DELETE CASCADE;
...
--
-- Name: mista_puvodu zeme_fk; Type: FK CONSTRAINT; Schema: public; Owner: doctordehi
--

ALTER TABLE ONLY public.mista_puvodu
    ADD CONSTRAINT zeme_fk FOREIGN KEY (zeme) REFERENCES public.zeme_puvodu(id_zem) ON DELETE CASCADE;


--
-- Name: TABLE barevne_razy; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.barevne_razy TO test;
GRANT SELECT ON TABLE public.barevne_razy TO rdbs_guest;


--
-- Name: SEQUENCE barevne_razy_id_raz_seq; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON SEQUENCE public.barevne_razy_id_raz_seq TO test;


--
-- Name: TABLE barvy; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.barvy TO test;
GRANT SELECT ON TABLE public.barvy TO rdbs_guest;


--
-- Name: SEQUENCE barvy_id_bar_seq; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON SEQUENCE public.barvy_id_bar_seq TO test;


--
-- Name: TABLE kresby; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.kresby TO test;
GRANT SELECT ON TABLE public.kresby TO rdbs_guest;


--
-- Name: SEQUENCE kresby_id_kre_seq; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON SEQUENCE public.kresby_id_kre_seq TO test;


--
-- Name: TABLE mista_puvodu; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.mista_puvodu TO test;
GRANT SELECT ON TABLE public.mista_puvodu TO rdbs_guest;


--
-- Name: SEQUENCE mista_puvodu_id_mis_seq; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON SEQUENCE public.mista_puvodu_id_mis_seq TO test;


--
-- Name: TABLE plemena; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.plemena TO test;
GRANT SELECT ON TABLE public.plemena TO rdbs_guest;


--
-- Name: TABLE plemena_razy; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.plemena_razy TO test;
GRANT SELECT ON TABLE public.plemena_razy TO rdbs_guest;


--
-- Name: TABLE plemena_barevne_razy_cele; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.plemena_barevne_razy_cele TO test;
GRANT SELECT ON TABLE public.plemena_barevne_razy_cele TO rdbs_guest;


--
-- Name: SEQUENCE plemena_id_ple_seq; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON SEQUENCE public.plemena_id_ple_seq TO test;


--
-- Name: TABLE plemena_inserted_log; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT SELECT ON TABLE public.plemena_inserted_log TO rdbs_guest;
...
GRANT ALL ON TABLE public.skupiny TO test;


--
-- Name: TABLE zeme_puvodu; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT SELECT ON TABLE public.zeme_puvodu TO rdbs_guest;


--
-- Name: TABLE plemena_shrnuti; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT SELECT ON TABLE public.plemena_shrnuti TO rdbs_guest;


--
-- Name: TABLE plemena_vsechny_razy; Type: ACL; Schema: public; Owner: doctordehi
--

GRANT ALL ON TABLE public.plemena_vsechny_razy TO test;
GRANT SELECT ON TABLE public.plemena_vsechny_razy TO rdbs_guest;


--
-- Name: SEQUENCE skupiny_id_sku_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.skupiny_id_sku_seq TO test;
GRANT ALL ON SEQUENCE public.skupiny_id_sku_seq TO doctordehi;
...
GRANT ALL ON TABLE public.velikosti TO test;


--
-- Name: SEQUENCE velikosti_id_vel_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.velikosti_id_vel_seq TO test;
GRANT ALL ON SEQUENCE public.velikosti_id_vel_seq TO doctordehi;
